...
#define V2FCommand_ReadPageTrigger 13      //Read data of a flash page; Store data to register of the flash die
#define V2FCommand_ReadPageTransfer 18     //Transter data from a flash die to data buffer; Inform bit error information to FTL
#define V2FCommand_ProgramPage 28          //Transfer data from data buffer to a flash die; Program data to a flash page
#define V2FCommand_BlockErase 37           //Erase a flash block
#define V2FCommand_StatusCheck 41          //Check a previous command execution result
