...
#define	PAGE_NUM_PER_LUN			(PAGE_NUM_PER_BLOCK * BLOCK_NUM_PER_LUN)  //128*4096=524288
#define	MAX_PAGE_NUM_PER_SLC_LUN		(PAGE_NUM_PER_SLC_BLOCK * MAX_BLOCK_NUM_PER_LUN)  //128*4096
#define	PAGE_NUM_PER_DIE			(PAGE_NUM_PER_LUN * LUN_NUM_PER_DIE)  //524288*2=1048576
